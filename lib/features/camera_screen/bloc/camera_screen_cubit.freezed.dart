...
mixin _$CameraScreenState {
 ...
 List<CameraDescription> get cameras; int get selectedCameraIndex; bool get isRecording; CameraMode get cameraMode; Uint8List? get selectedOverlay; CameraController? get controller;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(cameras),selectedCameraIndex,isRecording,cameraMode,const DeepCollectionEquality().hash(selectedOverlay),controller);

@override
String toString() {
  return 'CameraScreenState(cameras: $cameras, selectedCameraIndex: $selectedCameraIndex, isRecording: $isRecording, cameraMode: $cameraMode, selectedOverlay: $selectedOverlay, controller: $controller)';
}
...
@useResult
$Res call({
 List<CameraDescription> cameras, int selectedCameraIndex, bool isRecording, CameraMode cameraMode, Uint8List? selectedOverlay, CameraController? controller
});
...
/// Create a copy of CameraScreenState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? cameras = null,Object? selectedCameraIndex = null,Object? isRecording = null,Object? cameraMode = null,Object? selectedOverlay = freezed,Object? controller = freezed,}) {
...
as CameraMode,selectedOverlay: freezed == selectedOverlay ? _self.selectedOverlay : selectedOverlay // ignore: cast_nullable_to_non_nullable
...
class _CameraScreenState extends CameraScreenState {
  const _CameraScreenState({final  List<CameraDescription> cameras = const [], this.selectedCameraIndex = 0, this.isRecording = false, this.cameraMode = CameraMode.video, this.selectedOverlay, this.controller}): _cameras = cameras,super._();
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_cameras),selectedCameraIndex,isRecording,cameraMode,const DeepCollectionEquality().hash(selectedOverlay),controller);
...
/// Create a copy of CameraScreenState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? cameras = null,Object? selectedCameraIndex = null,Object? isRecording = null,Object? cameraMode = null,Object? selectedOverlay = freezed,Object? controller = freezed,}) {
